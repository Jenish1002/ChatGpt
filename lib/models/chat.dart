...
class ChatResponseChoice {
  ...
  static ChatResponseChoice fromJson(Map<String, dynamic> json) =>
      ChatResponseChoice(json['index'], ChatMessage.fromJson(json['message']),
          json['finish_reason'] ?? '');
...
class ChatResponseUsage {
  ...
  static ChatResponseUsage fromJson(Map<String, dynamic> json) =>
      ChatResponseUsage(json['prompt_tokens'], json['completion_tokens'],
          json['total_tokens']);
}
...
class ChatResponse {
  ...
  static ChatResponse fromJson(Map<String, dynamic> json) => ChatResponse(
      json['id'],
      json['object'],
...
class ChatResponseDelta {
  ...
  static ChatResponseDelta fromJson(Map<String, dynamic> json) =>
      ChatResponseDelta(json['role'] ?? '', json['content'] ?? '');
}
