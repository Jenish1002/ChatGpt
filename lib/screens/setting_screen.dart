...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  String obscureApiKey(String apiKey) {
    if (apiKey.length < 7) return 'Invalid API Key';
    if (apiKey.substring(0, 3) != 'sk-') return 'Invalid API Key';
    return 'sk-...' +
        LocalStorageService().apiKey.substring(
            LocalStorageService().apiKey.length - 4,
